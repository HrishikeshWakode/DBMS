...
SECRET_KEY = 'django-insecure-lw!^biuadmz^jayoqi#s!nt=fl0966%f*i$3-!4xs5wms83vv)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'bloodlife/templates'],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Mysqlpass@1',  # Replace with your MySQL password
